...
COMMENT ON TABLE "public"."locale" IS e'All of the available locales for all projects';

COMMENT ON COLUMN "public"."locale"."locale" IS E'The short code of the locale (en_US, en_GB, esp)';

COMMENT ON COLUMN "public"."locale"."name" IS E'The human readable version of the locale name';

INSERT INTO public.locale (locale, name) VALUES
( 'af', 'Afrikaans'),
...
-- # Audit table
SELECT audit.audit_table ('public.locale', TRUE, FALSE);
